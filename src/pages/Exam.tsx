...
const Exam = () => {
  ...
  useEffect(() => {
    toast({
      ...
      description: "Verbinden Sie Ihr Projekt mit Supabase, um echte Prüfungsfragen zu laden.",
      duration: 5000,
    });
  }, [toast]);
  ...
  const handleAnswerSelect = (answer: string) => {
    ...
    const isCorrect = answer === mockExamQuestions[currentQuestionIndex].correct_option;
    if (isCorrect) {
  ...
  const progress = examState === "running" ? ((currentQuestionIndex + 1) / mockExamQuestions.length) * 100 : 0;
            ...
            <Card className="card-3d p-8 text-center space-y-6">
              ...
              >
                ...
                <p className="text-2xl text-foreground mb-2">
                  {correctAnswers} von {mockExamQuestions.length} Fragen richtig
                </p>
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Frage {currentQuestionIndex + 1} von {mockExamQuestions.length}
            </p>
          </div>
